...
class Appr(Inc_Learning_Appr):
    ...
    def estimate_parameter_importance(self, trn_loader):
        ...
        for images, targets in itertools.islice(trn_loader, n_samples_batches):
            ...
            # Use mean squared error (MSE) for regression task
    ...
    def criterion(self, t, outputs, targets):
        ...
        # train_label = targets + np.random.normal(0, targets.shape[0])
        ...
        return loss + torch.nn.functional.mse_loss(outputs, targets)
